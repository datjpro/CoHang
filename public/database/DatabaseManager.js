  ...
  initializeSampleData() {
    try {
      ...
      const students = [
        ...
        {
          ho_ten: "Nguyễn Quang Minh",
          so_dien_thoai: "0988888888",
          dia_chi: "Ba Đình, Hà Nội",
          truong_hoc: "THPT Chu Văn An",
          lop: "11A3",
          muc_tieu: "Cải thiện điểm Toán",
          ho_ten_phu_huynh: "Nguyễn Văn Quang",
          sdt_phu_huynh: "0911111111",
        },
      ];
      ...
      const allTeachers = this.getAllTeachers();
      const allSubjects = this.getAllSubjects();

      if (allTeachers.length > 0 && allSubjects.length > 0) {
        const courses = [
          {
            ma_giao_vien: allTeachers[0].ma_giao_vien,
            ma_mon_hoc: allSubjects.find((s) => s.ten_mon_hoc === "Toán học")
              ?.ma_mon_hoc,
            ten_khoa_hoc: "Toán 12 - Luyện thi đại học",
            mo_ta: "Ôn tập toàn diện chương trình Toán 12",
            gia_tien: 2000000,
            loai_khoa_hoc: "ca_nhan",
          },
          {
            ma_giao_vien: allTeachers[1].ma_giao_vien,
            ma_mon_hoc: allSubjects.find((s) => s.ten_mon_hoc === "Vật lý")
              ?.ma_mon_hoc,
            ten_khoa_hoc: "Vật lý THPT - Cơ bản đến nâng cao",
            mo_ta: "Học vật lý từ cơ bản đến nâng cao",
            gia_tien: 1800000,
            loai_khoa_hoc: "nhom",
          },
        ];
      ...
      console.log("Sample data initialized successfully in DatabaseManager");
      return true;
    } catch (error) {
